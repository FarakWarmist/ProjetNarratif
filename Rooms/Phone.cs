...
@"
Vous arrivez à l'endroit indiqué sur la carte: un espace libre entouré par
les étagères et où plusieurs [DÉTRITUS] sont éparpillés sur le sol. Un
étrange [TÉLÉPHONE] fix se tient au beau milieu de se désordre.

Vous pouvez [REGARDER] les alentours, regarder votre [INVENTAIRE] ou vous
diriger vers un autre endroit avec votre [CARTE].
";
